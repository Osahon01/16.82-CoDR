...
class DEPSizingModel:
    ...
    # Core calculations
    # -------------------------
    def generator_kW_and_xto(self, params: dict) -> dict:
        # Mission
    ...
    def add_objective_metric(
        ...
        out2 = dict(out)
        out2["objective_J"] = self.objective_function(
            out,
            params,
            x_to_ref=x_to_ref,
            V_ref=V_ref,
...
if __name__ == "__main__":
    ...
    base_out = model.add_cruise_fuel_metrics(model.generator_kW_and_xto(params), params)
    x_to_ref = base_out["x_to_metric"]
    out = model.add_objective_metric(
        base_out,
        params,
        x_to_ref=x_to_ref,
        V_ref=params["V_ref"],
